...
// ASCII art
const asciiArt = `
 ______     __     __     ______     __   __     _____     __        
/\\  ___\\   /\\ \\  _ \\ \\   /\\  ___\\   /\\ "-.\\ \\   /\\  __-.  /\\ \\       
\\ \\___  \\  \\ \\ \\/ ".\\ \\  \\ \\  __\\   \\ \\ \\-.  \\  \\ \\ \\/\\ \\ \\ \\ \\____  
 \\/\\_____\\  \\ \\__/".~\\_\\  \\ \\_____\\  \\ \\_\\\\"\\_\\  \\ \\____-  \\ \\_____\\ 
  \\/_____/   \\/_/   \\/_/   \\/_____/   \\/_/ \\/_/   \\/____/   \\/_____/ 
                                                                      
`;

// Hacker-style logging function
function h4ck3rL0g(message, style = '') {
    const l33t = message.replace(/[aeio]/gi, match => {
        const l33tMap = { 'a': '4', 'e': '3', 'i': '1', 'o': '0' };
        return l33tMap[match.toLowerCase()] || match;
    });
    console.log(`%c${l33t}`, style);
}
...
console.log(`%c${asciiArt}`, 'color: #0f0; font-family: monospace; font-size: 10px;');

h4ck3rL0g("D3v3l0p3d by Sw3ndl", "color: #0f0; font-size: 20px; font-family: 'Courier New', monospace; text-shadow: 0 0 5px #0f0;");
h4ck3rL0g("Hunt1ng f0r bugs? L3t m3 kn0w 1f y0u f1nd 4ny.", "color: #00ffff; font-size: 14px; font-family: 'Courier New', monospace;");

// Simulated loading bar
console.log('%cL04d1ng syst3m...', 'color: #ff00ff; font-size: 16px; font-family: "Courier New", monospace;');
for (let i = 0; i <= 100; i += 10) {
    console.log(`%c[${'█'.repeat(i/10)}${' '.repeat(10-i/10)}] ${i}%`, 'color: #00ff00; font-family: monospace;');
}

// Matrix-style message reveal
const secretMessage = 'Fr33 C00k13s fr0m Sw3ndl 🍪';
let revealedMessage = '';
const revealInterval = setInterval(() => {
    if (revealedMessage.length < secretMessage.length) {
        revealedMessage += secretMessage[revealedMessage.length];
        console.clear();
        console.log(`%c${asciiArt}`, 'color: #0f0; font-family: monospace; font-size: 10px;');
        console.log(`%c${matrixRain()}`, 'color: #0f0; font-family: monospace;');
        console.log(`%c${revealedMessage}`, 'color: #ff00ff; font-size: 20px; font-family: "Courier New", monospace; text-shadow: 0 0 5px #ff00ff;');
        console.log(`%c${matrixRain()}`, 'color: #0f0; font-family: monospace;');
    } else {
        clearInterval(revealInterval);
        console.log('%cSyst3m 1nf1ltr4t3d succ3ssfully!', 'color: #ff0000; font-size: 18px; font-family: "Courier New", monospace; font-weight: bold;');
    }
}, 100);
