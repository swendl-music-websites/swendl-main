...
!(function (a, b, c) {
    ...
    (function (a, b, c) {
        b.extend(c.shares, {
            email: { label: "E-mail", logo: "fa-brands fa-at", shareUrl: "mailto:{to}?subject={text}&body={url}", countUrl: "", shareIn: "self" },
            twitter: { label: "Tweet", logo: "fa-brands fa-twitter", shareUrl: "https://twitter.com/share?url={url}&text={text}&via={via}&hashtags={hashtags}", countUrl: "" },
            facebook: {
                label: "Like",
            ...
            googleplus: { label: "+1", logo: "fa-brands fa-google", shareUrl: "https://plus.google.com/share?url={url}", countUrl: "" },
            linkedin: {
                label: "Share",
            ...
            telegram: { label: "Telegram", logo: "fa-brands fa-paper-plane", shareUrl: "tg://msg?text={url} {text}", countUrl: "", shareIn: "self" },
            whatsapp: { label: "WhatsApp", logo: "fa-brands fa-whatsapp", shareUrl: "whatsapp://send?text={url} {text}", countUrl: "", shareIn: "self" },
            line: { label: "LINE", logo: "fa-brands fa-comment", shareUrl: "http://line.me/R/msg/text/?{text} {url}", countUrl: "" },
            viber: { label: "Viber", logo: "fa-brands fa-volume-control-phone", shareUrl: "viber://forward?text={url} {text}", countUrl: "", shareIn: "self" },
            pocket: { label: "Pocket", logo: "fa-brands fa-get-pocket", shareUrl: "https://getpocket.com/save?url={url}&title={title}", countUrl: "" },
            messenger: { label: "Share", logo: "fa-brands fa-commenting", shareUrl: "fb-messenger://share?link={url}", countUrl: "", shareIn: "self" },
        });
...
class GridToFullscreenEffect {
    ...
    createTextures(e) {
        ...
        for (let t = 0; t < e.length; t++) {
            ...
            const s = { large: { element: r.large.element, texture: i }, small: { element: r.small.element, texture: o } };
            n.push(s);
        }
    ...
    init() {
        (this.renderer = new THREE.WebGLRenderer({ alpha: !0, antialias: !0 })),
            ...
            (this.camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 1e4)),
        ...
        var o = new THREE.ShaderMaterial({ uniforms: this.uniforms, vertexShader: i.vertex, fragmentShader: i.fragment, side: THREE.DoubleSide });
            ...
            (this.tween = TweenLite.to(this.uniforms.uProgress, this.options.timing.duration, {
                ...
                onComplete: () => {
                    (this.isAnimating = !1),
                        ...
                        this.resetUniforms(),
                        this.render(),
                        this.options.onToGridFinish && this.options.onToGridFinish({ index: -1, lastIndex: this.currentImageIndex }),
                        (this.currentImageIndex = -1);
                },
            })));
    }
    ...
    toFullscreen(e, n) {
        if (!this.isFullscreen && !this.isAnimating) {
            ...
            (this.itemsWrapper.style.zIndex = 0),
                ...
                this.options.onToFullscreenStart && this.options.onToFullscreenStart({ index: this.currentImageIndex }),
                (this.tween = TweenLite.to(this.uniforms.uProgress, this.options.timing.duration, {
                    value: 1,
                    ...
                    onComplete: () => {
                        (this.isAnimating = !1), (this.isFullscreen = !0), this.options.onToFullscreenFinish && this.options.onToFullscreenFinish({ index: this.currentImageIndex });
                    },
                }));
        }
    }
